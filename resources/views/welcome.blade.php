    ...
    <nav class="fixed w-full glass shadow-sm z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="px-4 py-2 text-gray-700 hover:text-green-600 transition font-medium">
                                Dashboard
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="px-4 py-2 text-gray-700 hover:text-green-600 transition font-medium">
                                Masuk
                            </a>
        ...
        <div id="mobile-menu" class="hidden md:hidden glass border-t">
            <div class="px-4 py-3 space-y-2">
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="block px-4 py-2 text-gray-700 hover:bg-green-50 rounded-lg transition font-medium">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="block px-4 py-2 text-gray-700 hover:bg-green-50 rounded-lg transition font-medium">
                            Masuk
                        </a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="block px-4 py-2 gradient-bg text-white rounded-lg text-center font-medium hover:opacity-90 transition">
                                Daftar Gratis
                            </a>
                        @endif
                    @endauth
    ...
    <section class="py-16 md:py-24 gradient-bg relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="btn-primary text-lg bg-white text-green-600 hover:bg-gray-100">
                        Mulai Gratis Sekarang
                    </a>
                @endif
                @if (Route::has('login'))
                    <a href="{{ route('login') }}" class="btn-primary text-lg bg-white text-green-600 hover:bg-gray-100">
