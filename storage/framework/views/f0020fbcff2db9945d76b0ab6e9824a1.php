    ...
    <div class="block sm:hidden">
            <div class="flex flex-col gap-4 p-4">
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('dashboard')); ?>" class="p-2 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg">
                ...
                <!-- FAQ Accordion -->
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryIndex => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 overflow-hidden">
                        <div class="px-4 py-3 bg-zinc-50 dark:bg-zinc-700/50 border-b border-zinc-200 dark:border-zinc-700">
                            <h3 class="font-bold text-zinc-900 dark:text-white"><?php echo e($category['category']); ?></h3>
                        </div>
                        <div class="divide-y divide-zinc-200 dark:divide-zinc-700">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $category['questions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qIndex => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $faqId = $categoryIndex . '-' . $qIndex; ?>
                                <div>
                                    <button 
                                        wire:click="toggleFaq('<?php echo e($faqId); ?>')"
                                    ...
                                    >
                                        <span class="font-medium text-sm text-zinc-900 dark:text-white pr-4"><?php echo e($faq['q']); ?></span>
                                        <svg class="w-5 h-5 text-zinc-400 shrink-0 transition-transform <?php echo e($openFaq === $faqId ? 'rotate-180' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                        </svg>
                                    </button>
                                    <!--[if BLOCK]><![endif]--><?php if($openFaq === $faqId): ?>
                        ...
                        <div class="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 overflow-hidden">
                            <div class="px-6 py-4 bg-gradient-to-r from-zinc-100 to-zinc-50 dark:from-zinc-700 dark:to-zinc-800 border-b border-zinc-200 dark:border-zinc-700">
                                <h3 class="font-bold text-lg text-zinc-900 dark:text-white flex items-center gap-2">
                                    <!--[if BLOCK]><![endif]--><?php if($category['category'] === 'Umum'): ?>
                                        <svg class="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                    <?php elseif($category['category'] === 'Task'): ?>
                                        <svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                                        </svg>
                                    <?php elseif($category['category'] === 'Pembayaran & Reward'): ?>
                            ...
                            <div class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $category['questions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qIndex => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div>
                                        ...
                                        >
                                            <span class="font-medium text-zinc-900 dark:text-white pr-4"><?php echo e($faq['q']); ?></span>
                                            <svg class="w-5 h-5 text-zinc-400 shrink-0 transition-transform <?php echo e($openFaq === $faqId ? 'rotate-180' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                            </svg>
                                        </button>
...
</div><?php /**PATH C:\laragon\www\template_design\resources\views\livewire/pages/faq.blade.php ENDPATH**/ ?>