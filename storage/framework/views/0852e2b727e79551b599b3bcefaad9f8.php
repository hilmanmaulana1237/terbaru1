            ...
            <li class="shrink basis-0 flex-1 group">
              <div class="min-w-7 min-h-7 w-full inline-flex flex-col items-center text-xs">
                <span class="size-10 flex justify-center items-center shrink-0 font-bold rounded-xl transition-all duration-300 shadow-md
                  <?php if($currentStep > $i): ?> bg-gradient-to-br from-green-500 to-green-600 text-white shadow-green-500/30
                  <?php elseif($currentStep === $i): ?> bg-gradient-to-br from-green-600 to-green-700 text-white ring-4 ring-green-200 dark:ring-green-500/30 shadow-green-500/40
                  <?php else: ?> bg-zinc-100 text-zinc-400 dark:bg-zinc-700 dark:text-zinc-500 <?php endif; ?>">
                ...
                <span class="block text-xs font-semibold mt-2 text-center leading-tight
                  <?php if($currentStep === $i): ?> text-green-600 dark:text-green-400
                  <?php elseif($currentStep > $i): ?> text-green-600 dark:text-green-400
                  <?php else: ?> text-zinc-400 dark:text-zinc-500 <?php endif; ?>">
      ...
      <div class="bg-white dark:bg-zinc-800/50 rounded-2xl shadow-lg border border-zinc-200 dark:border-zinc-700/50 overflow-hidden">
        <!--[if BLOCK]><![endif]--><?php if($currentStep === 1): ?>
          ...
          <div class="p-5">
            <div class="space-y-5">
              ...
              <!--[if BLOCK]><![endif]--><?php if(optional($task)->whatsapp_group_link): ?>
                <div x-data="{ copied: false }" class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4">
                  <div class="flex flex-col items-center justify-between gap-3">
                    ...
                    <div class="w-full flex flex-col gap-2 items-stretch">
                      <a href="<?php echo e($task->whatsapp_group_link); ?>" target="_blank" rel="noopener noreferrer" aria-label="Buka Grup WhatsApp" class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold transition-colors">
        ...
        <?php elseif(in_array($currentStep, [2, 3])): ?>
          ...
          <div class="p-5">
            <div class="space-y-5">
              <div class="text-center">
                <h2 class="text-xl font-bold text-zinc-900 dark:text-white mb-1">Upload Bukti Tahap <?php echo e($isStep2 ? 1 : 2); ?></h2>
                ...
                <div class="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border-2 border-yellow-300 dark:border-yellow-700 rounded-xl p-4" 
                  ...
                  <div class="flex items-center justify-center gap-3">
                    <div class="text-center">
                      ...
                      <p class="text-xs text-yellow-700 dark:text-yellow-400 mb-2">Segera upload bukti sebelum waktu habis!</p>
                  ...
                  <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4">
                    <div class="flex items-start gap-3">
                      ...
                      <div class="flex-1">
                        ...
                        <p class="text-red-800 dark:text-red-300 mt-1 text-sm"><?php echo e($rejectionMessage); ?></p>
                  ...
                  <div class="mt-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4">
                    <div class="flex items-start gap-3">
                      ...
                      <div class="text-left flex-1">
                        ...
                        <a href="<?php echo e(route('user.dashboard')); ?>" class="inline-flex items-center gap-1 mt-2 text-xs font-semibold text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300">
          ...
          <div class="bg-gray-50 dark:bg-zinc-800 px-5 py-4 border-t border-zinc-200 dark:border-zinc-700">
            ...
            <div class="flex justify-end">
              <button 
                ...
                <span wire:loading.remove wire:target="<?php echo e($isStep2 ? 'submitProof1' : 'submitProof2'); ?>">Submit for Verification</span>
                <span wire:loading wire:target="<?php echo e($isStep2 ? 'submitProof1' : 'submitProof2'); ?>" style="display: none;">Processing...</span>
              </button>
            </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
          </div>
        ...
        <?php else: ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($this->isTaskRejectedAndCancelled()): ?>
              <div class="text-center py-10">
                ...
                <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4 max-w-lg mx-auto">
                  ...
                  <p class="text-red-800 dark:text-red-300 mt-2 text-left text-sm"><?php echo e($this->getRejectionFeedback() ?: 'Pengiriman Anda tidak memenuhi persyaratan.'); ?></p>
                </div>
              </div>
            <?php else: ?>
              <div class="text-center py-10">
                ...
                <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4 max-w-lg mx-auto space-y-3">
                  <div class="flex justify-between items-center">
                    ...
                    <span class="px-3 py-1 bg-green-200 dark:bg-green-800 text-green-800 dark:text-green-200 rounded-full text-xs font-medium"><?php echo e(\App\Models\UserTask::STATUSES[optional($userTask)->status] ?? 'Completed'); ?></span>
                  </div>
                  <!--[if BLOCK]><![endif]--><?php if(optional($userTask)->payment_amount): ?>
                    <div class="flex justify-between items-center">
                      <span class="font-semibold text-green-800 dark:text-green-300 text-sm">Hadiah:</span>
                      <span class="text-lg font-bold text-green-700 dark:text-green-300">Rp <?php echo e(number_format($userTask->payment_amount, 0, ',', '.')); ?></span>
                    </div>
                  <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                  <!--[if BLOCK]><![endif]--><?php if(optional($userTask)->payment_amount): ?>
                    <div class="flex justify-between items-center">
          ...
          <div class="bg-gray-50 dark:bg-zinc-800 px-5 py-4 border-t border-zinc-200 dark:border-zinc-700">
            <div class="flex justify-center">
              <a href="<?php echo e(route('user.dashboard')); ?>" class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-green-500/30">
            ...
            <li class="shrink basis-0 flex-1 group">
                ...
                <div class="flex items-center w-full">
                  <div class="flex-1 h-1 bg-gray-200 dark:bg-zinc-700 group-first:invisible">
                    <div class="h-1 rounded-full transition-all duration-500
                      <?php if($currentStep >= $i): ?> bg-green-600 w-full
                      <?php else: ?> bg-gray-200 dark:bg-zinc-700 w-0 <?php endif; ?>">
                    </div>
                  </div>
                  <span class="size-8 flex justify-center items-center shrink-0 font-bold rounded-full transition-all duration-300 mx-1
                    <?php if($currentStep > $i): ?> bg-green-600 text-white
                    <?php elseif($currentStep === $i): ?> bg-green-600 text-white ring-4 ring-green-200 dark:ring-green-500/30
                    <?php else: ?> bg-gray-200 text-gray-600 dark:bg-zinc-700 dark:text-zinc-300 <?php endif; ?>">
                    <!--[if BLOCK]><![endif]--><?php if($currentStep > $i): ?>
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg>
                    <?php else: ?>
                      <?php echo e($i); ?>
                  ...
                  <div class="flex-1 h-1 bg-gray-200 dark:bg-zinc-700 group-last:invisible">
                    <div class="h-1 rounded-full transition-all duration-500
                      <?php if($currentStep > $i): ?> bg-green-600 w-full
                      <?php elseif($currentStep === $i): ?> bg-green-600 w-1/2
                      <?php else: ?> bg-gray-200 dark:bg-zinc-700 w-0 <?php endif; ?>">
                    </div>
                  </div>
                </div>
              ...
              <div class="mt-3">
                <span class="block text-sm font-medium text-center
                  <?php if($currentStep === $i): ?> text-green-600 dark:text-green-400
                  <?php elseif($currentStep > $i): ?> text-zinc-800 dark:text-zinc-200
                  <?php else: ?> text-zinc-500 dark:text-zinc-400 <?php endif; ?>">
                  <?php echo e($this->getStepLabel($i)); ?>
      ...
      <div class="bg-white dark:bg-zinc-800/50 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-700/50 overflow-hidden">
        <!--[if BLOCK]><![endif]--><?php if($currentStep === 1): ?>
          ...
          <div class="p-6 sm:p-8">
            <div class="space-y-6">
              ...
              <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-5">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-4">
                    ...
                    <div>
                      <p class="font-semibold text-blue-900 dark:text-blue-200 text-lg"><?php echo e(optional(optional($task)->creator)->name ?? 'Admin'); ?></p>
                ...
                <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-5">
                  <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div x-data="{ copied: false }" class="inline-flex items-center gap-2">
                      <a href="<?php echo e($task->whatsapp_group_link); ?>" target="_blank" rel="noopener noreferrer" aria-label="Buka Grup WhatsApp" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold transition-colors transform hover:scale-105 flex-shrink-0">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.148z"/></svg>
                        Gabung Grup
                      </a>
              ...
              <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-5" x-data="{ understood: <?php if ((object) ('understoodInstructions') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('understoodInstructions'->value()); ?>')<?php echo e('understoodInstructions'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('understoodInstructions'); ?>')<?php endif; ?> }">
        ...
        <?php elseif(in_array($currentStep, [2, 3])): ?>
          ...
          <div class="p-6 sm:p-8">
            <div class="space-y-6">
              <div class="text-center">
                <h2 class="text-2xl font-bold text-zinc-900 dark:text-white mb-1">Upload Bukti Tahap <?php echo e($isStep2 ? 1 : 2); ?></h2>
                  ...
                  <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-5">
                    <div class="flex items-start gap-4">
                      ...
                      <div class="flex-1">
                        ...
                        <p class="text-red-800 dark:text-red-300 mt-1"><?php echo e($rejectionMessage); ?></p>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                  ...
                  <div class="mt-8 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-6 max-w-xl mx-auto">
                    <div class="flex items-start gap-4">
                      ...
                      <div class="text-left flex-1">
                        ...
                        <a href="<?php echo e(route('user.dashboard')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm font-semibold transition-colors">
                          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                          Kembali ke Dashboard
                        </a>
                      </div>
            ...
            <!--[if BLOCK]><![endif]--><?php if($this->isTaskRejectedAndCancelled()): ?>
              <div class="text-center py-12">
                ...
                <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-5 max-w-lg mx-auto">
                  ...
                  <p class="text-red-800 dark:text-red-300 mt-2 text-left"><?php echo e($this->getRejectionFeedback() ?: 'Pengiriman Anda tidak memenuhi persyaratan.'); ?></p>
                </div>
                <div class="mt-8">
                  <a href="<?php echo e(route('user.dashboard')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="text-center py-12">
                ...
                <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-5 max-w-lg mx-auto space-y-3">
                  <div class="flex justify-between items-center">
                    ...
                    <span class="px-3 py-1 bg-green-200 dark:bg-green-800 text-green-800 dark:text-green-200 rounded-full text-sm font-medium"><?php echo e(\App\Models\UserTask::STATUSES[optional($userTask)->status] ?? 'Completed'); ?></span>
                  </div>
                  <!--[if BLOCK]><![endif]--><?php if(optional($userTask)->payment_amount): ?>
                    <div class="flex justify-between items-center">
                      <span class="font-semibold text-green-800 dark:text-green-300">Hadiah:</span>
                      <span class="text-xl font-bold text-green-700 dark:text-green-300">Rp <?php echo e(number_format($userTask->payment_amount, 0, ',', '.')); ?></span>
                    </div>
                  <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                  <!--[if BLOCK]><![endif]--><?php if(optional($userTask)->payment_amount): ?>
                    <div class="flex justify-between items-center">
          ...
          <div class="bg-gray-50 dark:bg-zinc-800 px-6 sm:px-8 py-4 border-t border-zinc-200 dark:border-zinc-700">
            <div class="flex justify-center">
              <a href="<?php echo e(route('user.dashboard')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-green-500/30">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                Kembali ke Dashboard
              </a>
            </div>
    ...
    >
      ...
      <div class="p-4 space-y-4">
        ...
        <div class="flex items-center gap-3 p-3 bg-zinc-50 dark:bg-zinc-700/50 rounded-xl">
          ...
          <div class="flex-1 min-w-0">
            <p class="font-semibold text-zinc-900 dark:text-white truncate"><?php echo e(optional(optional($task)->creator)->name ?? 'Admin'); ?></p>
        ...
        <div class="space-y-2">
          <?php if(optional(optional($task)->creator)->whatsapp): ?>
            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', optional(optional($task)->creator)->whatsapp)); ?>?text=<?php echo e(urlencode('Halo Admin, saya butuh bantuan untuk task: ' . optional($task)->title)); ?>" 
               target="_blank" 
          ...
          <?php if(optional(optional($task)->creator)->phone): ?>
            <a href="tel:<?php echo e(optional(optional($task)->creator)->phone); ?>" 
              ...
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
              <span>Telepon: <?php echo e(optional(optional($task)->creator)->phone); ?></span>
            </a>
          <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

          <!--[if BLOCK]><![endif]--><?php if(!optional(optional($task)->creator)->whatsapp && !optional(optional($task)->creator)->phone): ?>
...
<?php /**PATH C:\laragon\www\template_design\resources\views/livewire/task-work-wizard.blade.php ENDPATH**/ ?>